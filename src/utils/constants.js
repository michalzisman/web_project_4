...
export const editProfilePicForm = document.querySelector(
  ".popup_type_edit-profilePic"
);
export const deleteCardForm = document.querySelector(".popup_type_delete-card");
...
export const openAddPlaceFormBtn = document.querySelector(
  ".profile__add-button"
);
...
export const inputImageTitle = addPlaceForm.querySelector(
  ".form__input_field_title"
);
export const inputImageLink = addPlaceForm.querySelector(
  ".form__input_field_link"
);
export const inputProfilePicLink = editProfilePicForm.querySelector(
  ".form__input_field_link"
);
